...
def cost_randomized(params, x, P980s, coin):
    c1, c2, c3, c4, k31, k41, k51 = params
    c1, c2, c3, c4, k31, k41, k51 = 10**c1, 10**c2, 10**c3, 10**c4, 10**k31, 10**k41, 10**k51
...
def grad_randomized(x_plus, x_minus, x, P980s, epsilon):
    ...
    return (cost_randomized(x_plus, x, P980s, coin) -
            cost_randomized(x_minus, x, P980s, coin)) / (2 * epsilon)
...
def gradient_descent_rand(params, learning_rate, iterations, x, P980s):
    costs = []
    ...
    for epoch in tqdm(range(iterations)):
        ...
        for i in range(len(params)):
            ...
            if rand < thre:
                ...
                grad[i] = grad_randomized(params_plus, params_minus, x, P980s, epsilon)
